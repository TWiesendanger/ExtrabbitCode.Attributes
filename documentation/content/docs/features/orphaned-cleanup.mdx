...
<img src="/images/screenshots/feature-orphaned-light.png" alt="Feature addAttribute" className="block dark:hidden" />
<img src="/images/screenshots/feature-orphaned-dark.png" alt="Feature addAttribute" className="hidden dark:block" />
