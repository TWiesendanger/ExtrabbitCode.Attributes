...
<PublicImage src="/images/screenshots/feature-orphaned-light.png" alt="Feature addAttribute" className="block dark:hidden" />
<PublicImage src="/images/screenshots/feature-orphaned-dark.png" alt="Feature addAttribute" className="hidden dark:block" />
